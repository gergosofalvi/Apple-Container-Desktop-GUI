...
enum ImagePresets {
    static let all: [ImagePreset] = [
        ...
        ImagePreset(id: "wordpress", name: "WordPress", image: "wordpress:latest", category: "Apps", description: "CMS with Apache + PHP. Requires a MySQL/MariaDB container (e.g. MariaDB preset) on the same network named db.", defaultPorts: [PortMapping(hostPort: "8080", containerPort: "80")], defaultVolumes: [VolumeMount(hostPath: "~/container-data/wordpress/wp-content", containerPath: "/var/www/html/wp-content")], defaultEnv: [EnvVariable(key: "WORDPRESS_DB_HOST", value: "db"), EnvVariable(key: "WORDPRESS_DB_USER", value: "wordpress"), EnvVariable(key: "WORDPRESS_DB_PASSWORD", value: "wordpress"), EnvVariable(key: "WORDPRESS_DB_NAME", value: "wordpress")]),
